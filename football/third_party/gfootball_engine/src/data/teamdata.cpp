...
TeamData::TeamData(int teamDatabaseID, const std::vector<FormationEntry> &f) {
  ...
  switch (teamDatabaseID) {
    ...
    case 3:
      name = "Argentina";
      logo_url = "images_teams/world_cup/argentina_logo.png";
      kit_url = "images_teams/world_cup/argentina";
      shortName = "ARG";
      color1 = Vector3(117, 170, 219);
      color2 = Vector3(255, 255, 255);
      break;
    case 8:
      name = "France";
      logo_url = "images_teams/world_cup/france_logo.png";
      kit_url = "images_teams/world_cup/france";
      shortName = "FRA";
      color1 = Vector3(0, 0, 145);
      color2 = Vector3(225, 0, 15);
      break;
  }
